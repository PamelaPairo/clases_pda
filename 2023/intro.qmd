...
title-slide-attributes:
    data-background-image: "C:/Users/pamel/Desktop/PDA/ML/img/portada.jpg"
format: 
  revealjs:
    theme: [mytheme.scss]
    slide-number: c
    ...
    width: 1600
    height: 1000
    logo: "C:/Users/pamel/Desktop/PDA/ML/img/logo.jpg"
...
![](C:/Users/pamel/Desktop/PDA/ML/img/pairo.png){.fragment width="250" fig-align="center"}
...
::: {layout="[[1,1], [1,1]]"}
![Detectar la probabilidad de que la transacción sea un fraude (Fraud Detection Models)](C:/Users/pamel/Desktop/PDA/ML/img/cards.png)

![Product Recommender](C:/Users/pamel/Desktop/PDA/ML/img/netflix.jpg)

![Probabilidad de que un usuario cliquee un anuncio (Click Prediction Models)](C:/Users/pamel/Desktop/PDA/ML/img/logos.jpg)
:::
...
![](C:/Users/pamel/Desktop/PDA/ML/img/ml.png){fig-align="center"}
...
![](C:/Users/pamel/Desktop/PDA/ML/img/ciclo_data.png){fig-align="center"}
...
::: {.column width="50%"}
![](C:/Users/pamel/Desktop/PDA/ML/img/regresion.png){.absolute top="0" right="30" width="500" height="450"}

![](C:/Users/pamel/Desktop/PDA/ML/img/clasification.png){.absolute bottom="0" right="30" width="500" height="450"}
:::
:::
...
![](C:/Users/pamel/Desktop/PDA/ML/img/split_data.png){.fragment width="500" lenght="700" fig-align="center"}
...
##  {background-image="C:/Users/pamel/Desktop/PDA/ML/img/computadora.jpg" background-size="cover"}
...
## <img src="https://raw.githubusercontent.com/quarto-dev/quarto-web/main/favicon.png" style="display: inline-block; margin: 0; margin-bottom: -2px; height: 45px;"/></img> Quarto, la próxima generación de RMarkdown

> Quarto es una interfaz de línea de comandos (CLI) que presenta formatos de texto sin formato (`.qmd`, `.rmd`, `.md`) O formatos mixtos (`.ipynb`/Jupyter notebook) en informes estáticos en PDF/Word/HTML , libros, sitios web, presentaciones y más 🎉

. . .

Un archivo .qmd y .Rmd permiten unificar bloques de códigos o *chunks* con texto plano o con formato simple de leer usando [[markdown](https://markdown.es/sintaxis-markdown/)]{style="text-decoration: underline;"}. Al poder intercalar cálculos y gráficos con su análisis o explicación, se unifica el flujo de trabajo. Esto es muy importante si buscamos que nuestro trabajo sea **reproducible**, pero además ahorra tiempo.

. . .

También...

Soporta varios lenguajes como R, Python y Julia y *environments* como Observable, VS Code y Jupyter Lab.

## Archivo .qmd {chalkboard-buttons="true"}

::: panel-tabset
### Descarga

Realizar la descarga de Quarto desde este [[link](https://quarto.org/docs/get-started/)]{style="text-decoration: underline;"}

Luego seguir la siguiente ruta para abrir un .qmd

```         
File > New > Quarto documentation
```
...
::: columns
::: {.column width="50%"}
![](C:/Users/pamel/Desktop/PDA/ML/img/comunidades_latin.png)
:::

::: {.column width="50%"}
![[18 al 20 de octubre de 2023, Presencial](https://latin-r.com/) Talleres y presentaciones orales.](C:/Users/pamel/Desktop/PDA/ML/img/latinr.jpg){width="60%"}
:::
:::
