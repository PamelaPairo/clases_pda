...
Si se hace lo contrario, puede ocurrir que los mismos datos estén presentes tanto en el conjunto de entrenamiento como en el conjunto de testeo (_data leakage_), causando el _overfitting_ y la baja generalización del modelo.
