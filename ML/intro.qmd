...
Un archivo .qmd y .Rmd permiten unificar bloques de códigos o _chunks_ con texto plano o con formato simple de leer usando [markdown](https://markdown.es/sintaxis-markdown/). Al poder intercalar cálculos y gráficos con su análisis o explicación, se unifica el flujo de trabajo. Esto es muy importante si buscamos que nuestro trabajo sea [**reproducible**]{style="text-decoration: underline;"}, pero además ahorra tiempo.
...
### Salida
![](https://quarto.org/images/hello-knitr.png){width=50%}
