...
Un archivo .qmd y .Rmd permiten unificar bloques de códigos o _chunks_ con texto plano o con formato simple de leer usando [[markdown](https://markdown.es/sintaxis-markdown/)]{style="text-decoration: underline;"}. Al poder intercalar cálculos y gráficos con su análisis o explicación, se unifica el flujo de trabajo. Esto es muy importante si buscamos que nuestro trabajo sea **reproducible**, pero además ahorra tiempo.

. . .

También...

Soporta varios lenguajes como R, Python y Julia y _environments_ como Observable, VS Code y Jupyter Lab.
...
![[10-14 de octubre LatinR, VIRTUAL](https://latin-r.com/) Talleres y presentaciones orales.](img/latinr.jpg){width=60%}
